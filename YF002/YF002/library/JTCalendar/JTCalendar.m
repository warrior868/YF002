...
- (void)setMenuMonthsView:(JTCalendarMenuView *)menuMonthsView
{
    ...
    [self.menuMonthsView setDelegate:self];
    [self.menuMonthsView setCalendarManager:self];
...
- (void)setContentView:(JTCalendarContentView *)contentView
{
    ...
    [self.contentView setCalendarManager:nil];
    
    self.contentView = contentView;
    [self.contentView setDelegate:self];
    [self.contentView setCalendarManager:self];
